...
impl Temperature {
    ...
    pub fn read_temperature(&self) -> ThermodynamicTemperature {
        ThermodynamicTemperature::new::<degree_celsius>(self.read_raw_temperature() as f64 / 128.0)
    }
}
...
impl TemperatureOffset {
    ...
    pub fn read_temperature_offset(&self) -> ThermodynamicTemperature {
        ThermodynamicTemperature::new::<degree_celsius>(self.read_raw_temperature_offset() as f64 / 128.0)
    }
