...
//! # fn test<I, D>(mut i2c: I, delay: D) -> Result<(), embedded_devices::devices::sensirion::sen63c::Error<I::Error>>
//! # where
...
//! # async fn test<I, D>(mut i2c: I, delay: D) -> Result<(), embedded_devices::devices::sensirion::sen63c::Error<I::Error>>
//! # where
...
/// The SEN63C is a particulate matter (PM) sensor from Sensition's SEN6x sensor module family.
///
...
pub struct SEN63C<D: hal::delay::DelayNs, I: embedded_registers::RegisterInterface> {
    /// The delay provider
    delay: D,
...
impl<D, I> SEN63C<D, embedded_registers::i2c::I2cDevice<I, hal::i2c::SevenBitAddress>>
where
...
impl<D: hal::delay::DelayNs, I: embedded_registers::RegisterInterface> SEN63C<D, I> {
