...
pub struct SEN68<D: hal::delay::DelayNs, I: embedded_registers::RegisterInterface> {
    /// The delay provider
    delay: D,
...
impl<D, I> SEN68<D, embedded_registers::i2c::I2cDevice<I, hal::i2c::SevenBitAddress>>
where
