...
pub struct SCD43<D: hal::delay::DelayNs, I: embedded_interfaces::registers::RegisterInterface> {
    /// The delay provider
    delay: D,
...
impl<D: hal::delay::DelayNs, I: embedded_interfaces::registers::RegisterInterface> SCD43<D, I> {
