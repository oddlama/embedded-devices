...
pub struct SCD40<D: hal::delay::DelayNs, I: embedded_registers::RegisterInterface> {
    /// The delay provider
    delay: D,
...
impl<D, I> SCD40<D, embedded_registers::i2c::I2cDevice<I, hal::i2c::SevenBitAddress>>
where
...
impl<D: hal::delay::DelayNs, I: embedded_registers::RegisterInterface> SCD40<D, I> {
...
impl<D: hal::delay::DelayNs, I: embedded_registers::RegisterInterface> crate::device::ResettableDevice for SCD40<D, I> {
...
impl<D: hal::delay::DelayNs, I: embedded_registers::RegisterInterface> crate::sensor::ContinuousSensor for SCD40<D, I> {
    type Error = TransportError<I::BusError>;
