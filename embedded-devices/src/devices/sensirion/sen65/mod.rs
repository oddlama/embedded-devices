...
//! # fn test<I, D>(mut i2c: I, delay: D) -> Result<(), embedded_devices::devices::sensirion::sen65::MeasurementError<I::Error>>
//! # where
...
//! # async fn test<I, D>(mut i2c: I, delay: D) -> Result<(), embedded_devices::devices::sensirion::sen65::MeasurementError<I::Error>>
//! # where
...
pub struct SEN65<D: hal::delay::DelayNs, I: embedded_interfaces::commands::CommandInterface> {
    /// The delay provider
    delay: D,
...
impl<D: hal::delay::DelayNs, I: embedded_interfaces::commands::CommandInterface> SEN65<D, I> {
