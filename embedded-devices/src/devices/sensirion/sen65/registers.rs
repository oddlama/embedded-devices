...
#[device_register(super::SEN65)]
#[register(address = 0x0446, mode = "r", i2c_codec = "SensirionI2cCodec")]
#[bondrewd(read_from = "msb0", default_endianness = "be", enforce_bytes = 16)]
...
/// second), all values will be at their upper limit (0xFFFF for u16, 0x7FFF for i16).
#[device_register(super::SEN65)]
#[register(address = 0x0455, mode = "r", i2c_codec = "SensirionI2cCodec")]
