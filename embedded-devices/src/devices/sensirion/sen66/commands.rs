...
pub use crate::devices::sensirion::sen6x::commands::{
    ActivateSHTHeater, AmbientPressure, DeviceReset, GetCo2SensorAutomaticSelfCalibration, GetDataReady,
    GetNOxAlgorithmTuningParameters, GetProductName, GetSensorAltitude, GetSerialNumber, GetVOCAlgorithmState,
    GetVOCAlgorithmTuningParameters, PerformForcedCo2Recalibration, ReadNumberConcentrationValues,
    SetCo2SensorAutomaticSelfCalibration, SetNOxAlgorithmTuningParameters, SetSensorAltitude,
    SetTemperatureAccelerationParameters, SetTemperatureOffsetParameters, SetVOCAlgorithmState,
    SetVOCAlgorithmTuningParameters, StartContinuousMeasurement, StartFanCleaning, StopMeasurement,
};
...
interface_objects! {
    ...
    struct MeasuredRawValues(size=10) {
...
define_sensirion_commands! {
    ...
    read 0x0300 time_ms=20 ReadMeasuredValues() -> MeasuredValues;
    ...
    ///
    /// May be executed during measurement.
    read 0x0405 time_ms=20 ReadMeasuredRawValues() -> MeasuredRawValues;
